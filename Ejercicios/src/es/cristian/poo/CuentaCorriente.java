...
public static class CrearCuentaCorriente{
	...
	public String setAndGetIngresoSaldo(double saldo) {
		...
		if(saldo<=0)return "No se puede ingresar un número negativo";
		else {
	...
	public String getDatos() {
		...
		return "El titular es: " + this.nombre + " el saldo es: " + this.saldo + " el número de cuenta es: " + this.numCuenta;
	}
