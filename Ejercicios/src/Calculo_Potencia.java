...
public class Calculo_Potencia {
	...
	public static void main(String[] args) {
		 ...
		 * Declara dos variables en la misma línea con los nombres de 
		 * “base” y “exponente”.

		En la siguiente línea de código inicia la variable “base” 
		en 5. A continuación inicia la variable “exponente” en 12.

		Crea una variable con el nombre de “resultado” donde se
		almacenará el cálculo de “base” elevado a “exponente”.

		Al ejecutar el programa, deberá salir en consola el 
